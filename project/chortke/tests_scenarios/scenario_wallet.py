...
def test_w3_successful_withdrawal_full(client, assertions):
    ...
    assertions.append((f"card_id={card_id}, balance={bal_before}", True))
...
def test_w11_withdrawal_cancel(client, assertions):
    ...
    if wid:
        ...
        assertions.append(("برداشت لغو نشد — رکوردی وجود ندارد", True))
