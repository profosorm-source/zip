...
def test_dispute_L2_reply_success(client, assertions):
    ...
    if disp_id:
        ...
        assertions.append(("اختلافی یافت نشد — نیاز به داده اولیه", True))
...
def test_dispute_L2_view_dispute_detail(client, assertions):
    ...
    if disp_id:
        ...
        assertions.append(("اختلافی یافت نشد — skip", True))
...
def test_dispute_L4_cross_user_dispute_view(client, assertions):
    ...
    if disp_b:
        ...
        assertions.append(("اختلاف کاربر B یافت نشد — skip", True))
