...
// PSR-4 skip: TapsellVideoRewardAdapter lives in AdVideoRewardManager.php.
$videoRewardAdapters = __DIR__ . '/app/Adapters/AdVideoRewardManager.php';
if (file_exists($videoRewardAdapters)) {
    require_once $videoRewardAdapters;
}
