...
$r->post('/kyc/store',    [UserKYCController::class, 'submit'], $authCSRF);
...
$r->post('/bank-cards/{id}/set-default',  [UserBankCardController::class, 'setDefault'], $authCSRF);
...
$r->post('/notifications/{id}/mark-read',          [UserNotificationController::class, 'markAsRead'],        $authCSRF);
...
$r->post('/notifications/events/shown',            [UserNotificationController::class, 'eventShown'],       $authCSRF);
$r->post('/notifications/events/opened',           [UserNotificationController::class, 'eventOpened'],      $authCSRF);
$r->post('/notifications/events/closed',           [UserNotificationController::class, 'eventClosed'],      $authCSRF);
$r->post('/notifications/events/dismissed',        [UserNotificationController::class, 'eventDismissed'],   $authCSRF);
...
$r->post('/settings/data-export/request',          [SettingsController::class, 'requestDataExport'],         $authCSRF);
$r->post('/data-export/request',                   [SettingsController::class, 'requestDataExport'],         $authCSRF);
...
$r->post('/seo/{id}/start',    [SeoController::class, 'start'],       $authCSRF);
...
$r->post('/custom-tasks/{id}/start', [CustomTaskController::class, 'start'], $tasksSecure);

// ارسال مدرک (Ajax)
$r->post('/custom-tasks/{id}/submit-proof', [CustomTaskController::class, 'submitProof'], $tasksSecure);
$r->post('/custom-tasks/{id}/submit', [CustomTaskController::class, 'submitProof'], $tasksSecure);

// تایید/رد توسط تبلیغ‌دهنده (Ajax)
$r->post('/custom-tasks/review', [CustomTaskController::class, 'review'], $tasksSecure);
$r->post('/custom-tasks/{id}/approve', [AdsController::class, 'approveSubmission'], $tasksSecure);
$r->post('/custom-tasks/{id}/reject', [AdsController::class, 'rejectSubmission'], $tasksSecure);
...
// Static GET routes must precede /messages/{id}; otherwise "typing" and
// "unread" are consumed as conversation user IDs by the generic route.
...
$r->post('/lottery/{id}/join', [UserLotteryController::class, 'join'],  array_merge($authCSRF, [RequireFeature::class . ':lottery']));
$r->post('/lottery/vote',    [UserLotteryController::class, 'vote'],  array_merge($authCSRF, [RequireFeature::class . ':lottery']));
$r->post('/lottery/{id}/vote', [UserLotteryController::class, 'vote'],  array_merge($authCSRF, [RequireFeature::class . ':lottery']));
...
$r->post('/referral/generate-code', [UserReferralController::class, 'generateCode'], $referralAuth);
$r->post('/referral/set-referrer',  [UserReferralController::class, 'setReferrer'],  $referralAuth);
$r->post('/referral/rewards/claim', [UserReferralController::class, 'claimRewards'], $referralAuth);
$r->post('/referrals/generate',     [UserReferralController::class, 'generateCode'], $referralAuth);
$r->post('/referrals/set-referrer',  [UserReferralController::class, 'setReferrer'],  $referralAuth);
$r->post('/referrals/rewards/claim', [UserReferralController::class, 'claimRewards'], $referralAuth);
...
$r->post('/coupons/apply',    [CouponController::class, 'validate'], $couponsSecure);
...
$r->post('/social-tasks/{id}/start',    [SocialTaskController::class, 'start'],              $tasksSecure);
...
$r->get('/ads/{id}/notification-stats', [AdsController::class, 'notificationStats'], $tasksAuth);
...
$r->post('/user/custom-tasks/rate', [CustomTaskController::class, 'rateSubmission'], $authCSRF);
$r->post('/custom-tasks/rate', [CustomTaskController::class, 'rateSubmission'], $authCSRF);