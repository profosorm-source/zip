...
$router->post('/api/banner-click', [BannerController::class, 'click']);
$router->get('/api/banner-click', [BannerController::class, 'click']);

// security/csp aliases
$router->post('/api/security/event', [\App\Controllers\Api\SecurityController::class, 'logEvent']);
$router->post('/api/security/csp-report', [\App\Controllers\Api\SecurityController::class, 'cspReport']);
...
if (in_array((string)config('app.env', 'production'), ['local', 'testing', 'development', 'dev', 'test'], true)) {
