...
$r->get('/prediction/game/{id}',  [PredictionController::class, 'show'],     $auth);
...
$r->post('/prediction/game/{id}/bet', [PredictionController::class, 'placeBet'], $authCSRF);
...
$r->post('/adtube/{id}/complete',              [AdtubeController::class, 'submit'],      $authCSRF);
...
$r->get('/vitrine/{id}/dispute/messages',  [VitrineController::class, 'disputeMessages'], $vitrineAuth);
$r->post('/vitrine/{id}/dispute/message',  [VitrineController::class, 'disputeMessage'],  $vitrineAuthCSRF);
