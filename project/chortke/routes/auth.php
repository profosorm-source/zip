...
$router->group(['middleware' => [GuestMiddleware::class, CSRFMiddleware::class]], function ($router) {
    $router->post('/register',        [UserAuthController::class, 'register'],        [CSRFMiddleware::class, RateLimitMiddleware::class . ':5,1', CaptchaMiddleware::class . ':register']);
    $router->post('/login',           [UserAuthController::class, 'login'],           [CSRFMiddleware::class, RateLimitMiddleware::class . ':10,1', CaptchaMiddleware::class . ':login']);
