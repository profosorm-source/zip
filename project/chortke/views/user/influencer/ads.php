      ...
      <table class="table table-hover mb-0" id="influencerTable">
        ...
        <tbody>
          ...
          <tr class="influencer-row" data-action="show-detail" data-id="<?= (int)$p->id ?>">
            ...
            <!-- عملیات -->
            <td class="text-center">
              <a href="<?= url('/influencer/ads/create?influencer_id=' . (int)$p->id) ?>" class="btn btn-primary btn-sm">
                ثبت سفارش
              </a>
            </td>
          </tr>
              ...
              <div class="p-3">
                <div class="row g-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <a href="<?= url('/influencer/ads/create?influencer_id=' . (int)$p->id) ?>" class="btn btn-primary btn-sm w-100">ثبت سفارش</a>
                  </div>
                </div>
              </div>
            </td>
...
$scripts = '<script nonce="<?= e(csp_nonce()) ?>" src="' . asset('assets/js/views/userinfluencerads.js') . '"></script>';
