...
def test_coupon_L1_smoke_coupon_page(client, assertions):
    ...
    assert_true(assertions, f"صفحه اصلی کوپن‌ها HTTP {code}", code in (200, 302, 404))
...
def test_coupon_L2_view_my_coupons(client, assertions):
    ...
    code, body = client.get('/coupons')
    assert_true(assertions, f"لیست کوپن‌ها بارگذاری شد HTTP {code}", code in (200, 302, 404))
...
def test_coupon_L7_browser_coupon_form_interaction(client, assertions):
    ...
    code, body = client.get('/coupons')
    assert_true(assertions, f"فرم کوپن در مرورگر بارگذاری شد HTTP {code}", code in (200, 302, 404))
