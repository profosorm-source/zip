...
def test_crypto_L2_crypto_list_has_records(client, assertions):
    ...
    code, body = client.get('/crypto-deposits')
    assert_true(assertions, f"تاریخچه رمزارز بارگذاری شد HTTP {code}", code in (200, 302, 404))
...
def test_crypto_L7_browser_crypto_deposit_form(client, assertions):
    ...
    code, body = client.get('/wallet/deposit/crypto')
    assert_true(assertions, f"فرم واریز رمزارز در مرورگر بارگذاری شد HTTP {code}", code in (200, 302, 404))
...
def test_crypto_L7_browser_crypto_history_table(client, assertions):
    ...
    code, body = client.get('/crypto-deposits')
    assert_true(assertions, f"جدول تاریخچه رمزارز در مرورگر بارگذاری شد HTTP {code}", code in (200, 302, 404))
