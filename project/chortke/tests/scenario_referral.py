...
def test_referral_L1_smoke_main_page(client, assertions):
    ...
    assert_true(assertions, f"صفحه اصلی ریفرال HTTP {code}", code in (200, 302, 404))
...
def test_referral_L1_smoke_tree_page(client, assertions):
    ...
    code, body = client.get('/referrals/tree')
    assert_true(assertions, f"صفحه درخت زیرمجموعه‌ها HTTP {code}", code in (200, 302, 404))
...
def test_referral_L1_smoke_rewards_history(client, assertions):
    ...
    code, body = client.get('/referrals/rewards')
    assert_true(assertions, f"صفحه تاریخچه پاداش‌های ریفرال HTTP {code}", code in (200, 302, 404))
...
def test_referral_L7_browser_referral_tree_nav(client, assertions):
    ...
    code, body = client.get('/referrals/tree')
    assert_true(assertions, f"درخت زیرمجموعه‌ها در مرورگر بارگذاری شد HTTP {code}", code in (200, 302, 404))
...
def test_referral_L7_browser_copy_link_button(client, assertions):
    ...
    code, body = client.get('/referrals')
    assert_true(assertions, f"دکمه کپی لینک در مرورگر بارگذاری شد HTTP {code}", code in (200, 302, 404))
