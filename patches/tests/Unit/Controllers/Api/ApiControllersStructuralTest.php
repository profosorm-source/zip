...
class ApiControllersStructuralTest extends TestCase
{
    ...
    public function testNoPrivatePropertyOverridesParentProtected(string $class): void
    {
        ...
        // نبودِ والد یک «قبولیِ خاموش» نیست: طبق قرارداد همین فایل، هر کنترلر
        // باید BaseController را extend کند. پس این حالت باید شکست باشد.
        $this->assertNotFalse(
            $parent,
            "$class والدی ندارد؛ کنترلرها باید BaseController را extend کنند."
        );
