...
def test_investment_L1_smoke_create_page(client, assertions):
    ...
    assert_true(assertions, f"صفحه ایجاد سرمایه‌گذاری HTTP {code}", code in (200, 302))
...
def test_investment_L1_smoke_history_page(client, assertions):
    ...
    assert_true(assertions, f"صفحه تاریخچه سود HTTP {code}", code in (200, 302))
...
def test_investment_L2_profit_history_view(client, assertions):
    ...
    code, body = client.get('/investment/profit-history')
    assert_true(assertions, f"تاریخچه سرمایه‌گذاری بارگذاری شد HTTP {code}", code in (200, 302))
...
def test_investment_L7_browser_plans_table_interaction(client, assertions):
    ...
    code, body = client.get('/investment')
    assert_true(assertions, f"جدول طرح‌های سرمایه‌گذاری در مرورگر بارگذاری شد HTTP {code}", code in (200, 302))
...
def test_investment_L7_browser_create_investment_form(client, assertions):
    ...
    code, body = client.get('/investment/create')
    assert_true(assertions, f"فرم خرید سرمایه‌گذاری در مرورگر بارگذاری شد HTTP {code}", code in (200, 302))
