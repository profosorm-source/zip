...
def test_tasks_L1_smoke_social_tasks_page(client, assertions):
    ...
    assert_true(assertions, f"صفحه تسک‌های اجتماعی HTTP {code}", code in (200, 302))
...
def test_tasks_L1_smoke_adtube_page(client, assertions):
    ...
    assert_true(assertions, f"صفحه AdTube HTTP {code}", code in (200, 302))
...
def test_tasks_L1_smoke_seo_page(client, assertions):
    ...
    assert_true(assertions, f"صفحه سئو HTTP {code}", code in (200, 302))
...
def test_tasks_L1_smoke_unified_marketplace_feed(client, assertions):
    ...
    assert_true(assertions, f"فید یکپارچه تسک‌ها HTTP {code}", code in (200, 302))
...
def test_tasks_L7_browser_marketplace_feed_interaction(client, assertions):
    ...
    code, body = client.get('/tasks')
    assert_true(assertions, f"فید بازارچه در مرورگر بارگذاری شد HTTP {code}", code in (200, 302))
...
def test_tasks_L7_browser_custom_task_submit_form(client, assertions):
    ...
    code, body = client.get('/custom-tasks')
    assert_true(assertions, f"صفحه تسک‌های سفارشی در مرورگر بارگذاری شد HTTP {code}", code in (200, 302))
