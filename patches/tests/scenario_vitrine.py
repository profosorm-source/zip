...
def test_vitrine_L1_smoke_vitrine_page(client, assertions):
    ...
    assert_true(assertions, f"صفحه ویترین HTTP {code}", code in (200, 302))
...
def test_vitrine_L1_smoke_create_listing_page(client, assertions):
    ...
    assert_true(assertions, f"صفحه ایجاد آگهی ویترین HTTP {code}", code in (200, 302))
...
def test_vitrine_L1_smoke_my_listings_page(client, assertions):
    ...
    assert_true(assertions, f"صفحه آگهی‌های من HTTP {code}", code in (200, 302))
...
def test_vitrine_L7_browser_vitrine_grid_interaction(client, assertions):
    ...
    code, body = client.get('/vitrine')
    assert_true(assertions, f"شبکه آگهی‌های ویترین در مرورگر بارگذاری شد HTTP {code}", code in (200, 302))
...
def test_vitrine_L7_browser_create_listing_form(client, assertions):
    ...
    code, body = client.get('/vitrine/create')
    assert_true(assertions, f"فرم ثبت آگهی در مرورگر بارگذاری شد HTTP {code}", code in (200, 302))
