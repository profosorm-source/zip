...
class ErrorContract
{
    ...
    /**
     * خطاهای فیلدمحور را روی قرارداد خطا می‌نشاند.
     *
     * پیش‌تر تنها factory متد validation() می‌توانست fieldErrors را مقداردهی کند؛
     * این متد همان قابلیت را برای سایر انواع خطا (مانند خطاهای بیزینسی که خطای
     * فیلدمحور همراه دارند) فراهم می‌کند تا کلید «errors» در خروجی JSON پر شود.
     *
     * @param array<string, mixed> $fieldErrors
     */
