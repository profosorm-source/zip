...
/**
 * HTML escape برای نصب‌کننده.
 *
 * این اسکریپت مستقل است و تا مرحله ۵ (که bootstrap/app.php را require می‌کند)
 * هیچ‌یک از helperهای فریم‌ورک بارگذاری نشده‌اند. اما قالب مراحل ۲ تا ۶ برای
 * چاپ توکن CSRF از e() استفاده می‌کرد؛ نتیجه «Call to undefined function e()»
 * و کرش کامل ویزارد نصب در همان مراحل بود.
 *
 * تعریف مشروط است تا اگر helperهای فریم‌ورک قبلاً بارگذاری شده باشند،
 * با تعریف اصلی تداخل پیدا نکند و همان پیاده‌سازی محصول به کار برود.
 */
